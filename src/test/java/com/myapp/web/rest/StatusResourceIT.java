...
import com.myapp.domain.Status;
import com.myapp.repository.StatusRepository;
...
class StatusResourceIT {
    ...
    public static Status createEntity(EntityManager em) {
        Status status = new Status().state(DEFAULT_STATE);
        return status;
    }
    ...
    public static Status createUpdatedEntity(EntityManager em) {
        Status status = new Status().state(UPDATED_STATE);
        return status;
    }
    ...
    void createStatus() throws Exception {
        ...
        assertThat(testStatus.getState()).isEqualTo(DEFAULT_STATE);
    }
    ...
    void putNewStatus() throws Exception {
        ...
        updatedStatus.state(UPDATED_STATE);
        ...
        Status testStatus = statusList.get(statusList.size() - 1);
        assertThat(testStatus.getState()).isEqualTo(UPDATED_STATE);
    }
    ...
    void fullUpdateStatusWithPatch() throws Exception {
        ...
        partialUpdatedStatus.state(UPDATED_STATE);
